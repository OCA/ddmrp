...
class BomStructureReport(models.AbstractModel):
    ...
    def _get_bom_lines(self, bom, bom_quantity, product, line_id, level):
        ...
        for line in res[0]:
            ...
            if line_id.product_id.bom_ids:
                ...
                lead_time = line_id.product_id.seller_ids and \
                    line_id.product_id.seller_ids[0].delay or 0.0
    ...
    def _get_line_vals(self, bom_line):
        ...
        if line.product_id.bom_ids:
            ...
            lead_time = (line.product_id.seller_ids and
                         line.product_id.seller_ids[0].delay) or 0
        return {
